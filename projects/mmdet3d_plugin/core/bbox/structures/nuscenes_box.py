...
class CustomNuscenesBox:
    ...
    def rotation_matrix(self) -> np.ndarray:
        ...
        :return: <float: 3, 3>. The box's rotation matrix.
        """
    ...
    def translate(self, x: np.ndarray) -> None:
        ...
        :param x: <float: 3, 1>. Translation in x, y, z direction.
        """
        self.center += x
    ...
    def corners(self, wlh_factor: float = 1.0) -> np.ndarray:
        ...
        :return: <float: 3, 8>. First four corners are the ones facing forward.
    ...
    def bottom_corners(self) -> np.ndarray:
        ...
        :return: <float: 3, 4>. Bottom corners. First two face forward, last two face backwards.
        """
